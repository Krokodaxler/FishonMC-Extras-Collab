        ...
        switch (type) {
            ...
            case PROFILEDATA -> {
                ...
                textList.addAll(List.of(
                        ...
                        assembleText("profileStats.variantCounts[ALBINO]", profileDataHandler.profileData.variantCounts.getOrDefault(FishVariant.ALBINO, 0)),
                        assembleText("profileStats.variantCounts[MELANISTIC]", profileDataHandler.profileData.variantCounts.getOrDefault(FishVariant.MELANISTIC, 0)),
                        assembleText("profileStats.variantCounts[TROPHY]", profileDataHandler.profileData.variantCounts.getOrDefault(FishVariant.TROPHY, 0)),
                        assembleText("profileStats.variantCounts[FABLED]", profileDataHandler.profileData.variantCounts.getOrDefault(FishVariant.FABLED, 0)),
                        assembleText("profileStats.variantCounts[SPOOKY]", profileDataHandler.profileData.variantCounts.getOrDefault(FishVariant.SPOOKY, 0)),
                        assembleText("profileStats.variantCounts[FROZEN]", profileDataHandler.profileData.variantCounts.getOrDefault(FishVariant.FROZEN, 0)),
                        assembleText("profileStats.rarityCounts[COMMON]", profileDataHandler.profileData.rarityCounts.getOrDefault(Rarity.COMMON, 0)),
                        assembleText("profileStats.rarityCounts[RARE]", profileDataHandler.profileData.rarityCounts.getOrDefault(Rarity.RARE, 0)),
                        assembleText("profileStats.rarityCounts[EPIC]", profileDataHandler.profileData.rarityCounts.getOrDefault(Rarity.EPIC, 0)),
                        assembleText("profileStats.rarityCounts[LEGENDARY]", profileDataHandler.profileData.rarityCounts.getOrDefault(Rarity.LEGENDARY, 0)),
                        assembleText("profileStats.rarityCounts[MYTHICAL]", profileDataHandler.profileData.rarityCounts.getOrDefault(Rarity.MYTHICAL, 0)),
                        assembleText("profileStats.fishSizeCounts[BABY]", profileDataHandler.profileData.fishSizeCounts.getOrDefault(FishSize.BABY, 0)),
                        assembleText("profileStats.fishSizeCounts[JUVENILE]", profileDataHandler.profileData.fishSizeCounts.getOrDefault(FishSize.JUVENILE, 0)),
                        assembleText("profileStats.fishSizeCounts[ADULT]", profileDataHandler.profileData.fishSizeCounts.getOrDefault(FishSize.ADULT, 0)),
                        assembleText("profileStats.fishSizeCounts[LARGE]", profileDataHandler.profileData.fishSizeCounts.getOrDefault(FishSize.LARGE, 0)),
                        assembleText("profileStats.fishSizeCounts[GIGANTIC]", profileDataHandler.profileData.fishSizeCounts.getOrDefault(FishSize.GIGANTIC, 0)),
                        ...
                        assembleText("profileStats.allVariantCounts[ALBINO]", profileDataHandler.profileData.allVariantCounts.getOrDefault(FishVariant.ALBINO, 0)),
                        assembleText("profileStats.allVariantCounts[MELANISTIC]", profileDataHandler.profileData.allVariantCounts.getOrDefault(FishVariant.MELANISTIC, 0)),
                        assembleText("profileStats.allVariantCounts[TROPHY]", profileDataHandler.profileData.allVariantCounts.getOrDefault(FishVariant.TROPHY, 0)),
                        assembleText("profileStats.allVariantCounts[FABLED]", profileDataHandler.profileData.allVariantCounts.getOrDefault(FishVariant.FABLED, 0)),
                        assembleText("profileStats.allVariantCounts[SPOOKY]", profileDataHandler.profileData.allVariantCounts.getOrDefault(FishVariant.SPOOKY, 0)),
                        assembleText("profileStats.allVariantCounts[FROZEN]", profileDataHandler.profileData.allVariantCounts.getOrDefault(FishVariant.FROZEN, 0)),
                        assembleText("profileStats.allRarityCounts[COMMON]", profileDataHandler.profileData.allRarityCounts.getOrDefault(Rarity.COMMON, 0)),
                        assembleText("profileStats.allRarityCounts[RARE]", profileDataHandler.profileData.allRarityCounts.getOrDefault(Rarity.RARE, 0)),
                        assembleText("profileStats.allRarityCounts[EPIC]", profileDataHandler.profileData.allRarityCounts.getOrDefault(Rarity.EPIC, 0)),
                        assembleText("profileStats.allRarityCounts[LEGENDARY]", profileDataHandler.profileData.allRarityCounts.getOrDefault(Rarity.LEGENDARY, 0)),
                        assembleText("profileStats.allRarityCounts[MYTHICAL]", profileDataHandler.profileData.allRarityCounts.getOrDefault(Rarity.MYTHICAL, 0)),
                        assembleText("profileStats.allFishSizeCounts[BABY]", profileDataHandler.profileData.allFishSizeCounts.getOrDefault(FishSize.BABY, 0)),
                        assembleText("profileStats.allFishSizeCounts[JUVENILE]", profileDataHandler.profileData.allFishSizeCounts.getOrDefault(FishSize.JUVENILE, 0)),
                        assembleText("profileStats.allFishSizeCounts[ADULT]", profileDataHandler.profileData.allFishSizeCounts.getOrDefault(FishSize.ADULT, 0)),
                        assembleText("profileStats.allFishSizeCounts[LARGE]", profileDataHandler.profileData.allFishSizeCounts.getOrDefault(FishSize.LARGE, 0)),
                        assembleText("profileStats.allFishSizeCounts[GIGANTIC]", profileDataHandler.profileData.allFishSizeCounts.getOrDefault(FishSize.GIGANTIC, 0)),
                        ...
                        assembleText("profileStats.variantDryStreak[ALBINO]", profileDataHandler.profileData.variantDryStreak.getOrDefault(FishVariant.ALBINO, 0)),
                        assembleText("profileStats.variantDryStreak[MELANISTIC]", profileDataHandler.profileData.variantDryStreak.getOrDefault(FishVariant.MELANISTIC, 0)),
                        assembleText("profileStats.variantDryStreak[TROPHY]", profileDataHandler.profileData.variantDryStreak.getOrDefault(FishVariant.TROPHY, 0)),
                        assembleText("profileStats.variantDryStreak[FABLED]", profileDataHandler.profileData.variantDryStreak.getOrDefault(FishVariant.FABLED, 0)),
                        assembleText("profileStats.variantDryStreak[SPOOKY]", profileDataHandler.profileData.variantDryStreak.getOrDefault(FishVariant.SPOOKY, 0)),
                        assembleText("profileStats.variantDryStreak[FROZEN]", profileDataHandler.profileData.variantDryStreak.getOrDefault(FishVariant.FROZEN, 0)),

                        assembleText("profileStats.rarityDryStreak[COMMON]", profileDataHandler.profileData.rarityDryStreak.getOrDefault(Rarity.COMMON, 0)),
                        assembleText("profileStats.rarityDryStreak[RARE]", profileDataHandler.profileData.rarityDryStreak.getOrDefault(Rarity.RARE, 0)),
                        assembleText("profileStats.rarityDryStreak[EPIC]", profileDataHandler.profileData.rarityDryStreak.getOrDefault(Rarity.EPIC, 0)),
                        assembleText("profileStats.rarityDryStreak[LEGENDARY]", profileDataHandler.profileData.rarityDryStreak.getOrDefault(Rarity.LEGENDARY, 0)),
                        assembleText("profileStats.rarityDryStreak[MYTHICAL]", profileDataHandler.profileData.rarityDryStreak.getOrDefault(Rarity.MYTHICAL, 0)),

                        assembleText("profileStats.fishSizeDryStreak[BABY]", profileDataHandler.profileData.fishSizeDryStreak.getOrDefault(FishSize.BABY, 0)),
                        assembleText("profileStats.fishSizeDryStreak[JUVENILE]", profileDataHandler.profileData.fishSizeDryStreak.getOrDefault(FishSize.JUVENILE, 0)),
                        assembleText("profileStats.fishSizeDryStreak[ADULT]", profileDataHandler.profileData.fishSizeDryStreak.getOrDefault(FishSize.ADULT, 0)),
                        assembleText("profileStats.fishSizeDryStreak[LARGE]", profileDataHandler.profileData.fishSizeDryStreak.getOrDefault(FishSize.LARGE, 0)),
                        assembleText("profileStats.fishSizeDryStreak[GIGANTIC]", profileDataHandler.profileData.fishSizeDryStreak.getOrDefault(FishSize.GIGANTIC, 0)),
